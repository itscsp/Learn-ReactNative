    ...
    August: {
      ...
      TRANSACTIONS: [
        ...
        },
        {
          ...
          date: "2025-08-10",
          type: "Expense",
          description: "Raksha Bandhan Gifts",
          category: "Amazon",
          amount: 3000,
        },
        {
  ...
  switch (action.type) {
    ...
    case "DELETE": {
      ...
      return {
        ...
        [month]: {
          ...state[month],
          TRANSACTIONS: state[month].TRANSACTIONS.filter(
            (txn) => txn.id !== id
          ),
        },
      };
...
function TransationContextProvider({ children }) {
  ...
  function getMonthlyReport(month, year) {
    dispatch({ type: "REPORT", payload: { month, year } });
  }
